...
from detection_pedestrain.msg import Pose_landmark.msg,Pose_landmarks.msg
...
video_path ="/home/rancho/1hmy/OpenFace/OpenFace/samples/book0_astar-2024-08-29_17.48.29.mp4"
...
out = cv2.VideoWriter("/home/rancho/1hmy/OpenFace/OpenFace/samples/book0_2.mp4", cv2.VideoWriter_fourcc(*"MJPG"), 20, size)
while cap.isOpened():    
    ret, frame = cap.read()
    if not ret:
      break
